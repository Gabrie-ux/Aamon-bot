...
const msg2 = await tr("Deja la estrella en el repositorio ")
const msg3 = await tr("Unete a nuestro canal de WhatsApp y informarte de todas la novedades/Actualizaciones del bot y mas")
